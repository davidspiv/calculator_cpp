...
default: build/main.o build/io.o build/taylorSeries.o
	$(CC) build/main.o build/io.o build/taylorSeries.o -o $(EXENAME)

#order-only-prerequisite for build dir
build/main.o: src/main.cpp include/io.h include/taylorSeries.h | build
